...
- dashboard: business_pulse__tabbed
  ...
  - title: Moving Average
    ...
    height: 6
    tab_name: Looker Academy - Business Pulse  Tabbed
  - title: Margins by Department and Category
    name: Margins by Department and Category
    model: thelook_ecommerce
    explore: order_items
    type: looker_column
    fields: [products.department, products.category, order_items.total_gross_margin]
