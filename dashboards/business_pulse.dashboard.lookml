...
- dashboard: business_pulse
  title: Looker Academy - Business Pulse
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: TRstk6iYUqDgANfEuEVJLk
  theme_name: ''
  layout: newspaper
  tabs:
  - name: ''
  ...
  - title: Average Order Value
    ...
    listen:
      ...
      Order Item Creation Date Date: order_items.created_date
    row: 0
    col: 0
    width: 2
    height: 3
  ...
  - title: Totals Sales by Category and Department
    ...
    tab_name: ''
  filters:
  - name: Order Item Creation Date Date
    title: Order Item Creation Date Date
    type: field_filter
